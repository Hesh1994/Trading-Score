   ...
   - **Relative Strength (Turnover)**: RS = stock turnover ÷ benchmark turnover, with Average RS over a configurable interval, trend detection and optional market-cap normalisation
